<?php
  ...
  if($conn != FALSE)
  {
    ...
    while($row = mysql_fetch_assoc($result))
    {
      ...
      echo "</td>";
      echo "<td style='width:5%; text-align:center;'>";
      echo "<button type='button' class='btn btn-danger btn-sm' data-toggle='modal' data-target='#modalChackDeleteAM' onclick = 'deleteAccountManagement(this,$UID)';><i class='fa fa-trash' aria-hidden='true'></i></button>";
      echo "</td>";
      echo "</tr>";
    }
  }
