    ...
    <script>
                  ...
                  function editAccountOnClick() {
                    ...
                    if (check == 1 || check == 2) {
                      ...
                      xmlhttp.open("POST", "EditAccountManagementA.php?uidreq=" + uidreq + fnamesend + lnamesend + unamesend + sidsend + departsend + emailsend + passSend + "&utypereq=" + utypereq + "&fnameEdit=" + lnameEdit + "&lnameEdit=" + utypereq, true);
                      xmlhttp.send();
