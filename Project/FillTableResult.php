...
//               echo "<i class='fa fa-check' aria-hidden='true' style='color:#2ECC71'></i>";
              echo "<i class='fa fa-check' aria-hidden='true' style='color:#2ECC71' onclick = 'ResultModalHeader($ID,$HidModal,$CountRowForModal,$modalResultHeader,1);' data-toggle='modal' data-target='#modalSourceFileSend'></i>";
            }
            else {
              echo "<i class='fa fa-times' aria-hidden='true' style='color:#E74C3C' onclick = 'ResultModalHeader($ID,$HidModal,$CountRowForModal,$modalResultHeader,1);' data-toggle='modal' data-target='#modalSourceFileSend'></i>";
            }
          echo "</td>";
        }
